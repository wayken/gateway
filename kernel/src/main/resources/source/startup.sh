...
readonly service_name=teambeit-gateway-kernel
readonly service_home=/root/gateway/kernel
readonly service_stdout_log=/root/gateway/kernel/stdout.log
readonly service_gc_log=/root/gateway/kernel/gc.log
readonly service_application_config=gateway.yaml
# 默认jvm参数
