<template>
  <div class="a-zone-protection-limit platform inline-flex-c-n-n">
...
const handleEdit = (data: any) => {
  const zone = router.currentRoute.value.params.id
  const id = data.id
  router.push({ path: `/zone/protection/limit/edit/${zone}/${id}` })
}
const handleDelete = (data: any) => {
  ...
  iopost('zone', 'xhrLimitRuleRemove', params, {
    onMessage: true
  }).then(() => {
    handleLoad()
  })
...
const handleDataUpdate = (data: any) => {
  ...
  iopost('zone', 'xhrLimitRuleUpdate', data, {
    onMessage: true
  }).then(() => {
    handleLoad()
  })
...
const handleExport = (data: any) => {
  ...
  useFileDownload(dataJson, `Limit_${data.id}_${formattedDate}.json`)
}
</script>
