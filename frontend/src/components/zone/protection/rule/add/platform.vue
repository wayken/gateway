<template>
  <div class="a-zone-protection-rule--add a-zone-common-form platform inline-flex-c-n-n">
    ...
    <div class="content">
      ...
      >
        ...
        <div class="card">
          ...
          <a-rule-action ref="ruleActionRef" :default-code="403" />
        </div>
      </el-form>
    </div>
...
const handleSubmit = async (deploy: boolean) => {
  ...
  formRef.value.validate((valid: boolean) => {
    ...
    iopost('zone', 'xhrWafRuleAdd', params, {
      onMessage: true
    }).then(() => {
